    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">MediQuick</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/medicines" className="text-gray-300 hover:text-white">Browse Medicines</Link></li>
              <li><Link href="/prescriptions" className="text-gray-300 hover:text-white">Upload Prescription</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
          <p>&copy; 2025 Patha Team. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
